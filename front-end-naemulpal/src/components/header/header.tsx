        ...
        <header className="flex max-w-full h-20 bg-black">
            ...
            <nav className="flex w-3/5 text-center max:text-blue-800 mobile:invisible mobile:w-0">
                <div className="relative flex-25 group h-full">
                    ...
                    <div className="absolute w-full text-center bg-black invisible group-hover:visible">
            ...
            <div className="flex w-1/5 leading-80 mobile:w-1/2">
                ...
                <button className="relative w-1/4 ml-4 mobile:invisible mobile:w-0 mobile:ml-0"><Image className="block m-auto" src="/img/search-svgrepo-com.svg" alt={"검색창 열기"} width={"24"} height={"24"}></Image></button>
                <button className="relative w-1/4 ml-4 mobile:invisible mobile:w-0 mobile:ml-0"><Image className="block m-auto" src="/img/user-svgrepo-com.svg" alt={"검색창 열기"} width={"25"} height={"25"}></Image></button>
                <button className="relative w-1/4 ml-4 mobile:w-1/4 mobile:mr-4"><Image className="block m-auto" src="/img/bag-svgrepo-com.svg" alt={"검색창 열기"} width={"26"} height={"26"}></Image></button>
                <button className="relative w-0 ml-4 invisible mobile:visible mobile:w-1/4 mobile:visible mobile:mr-4"><Image className="block m-auto mobile:w-" src="/img/detail-2-svgrepo-com.svg" alt={"메뉴 열기"} width={"26"} height={"26"}></Image></button>
            </div>
        </header>
    )
}